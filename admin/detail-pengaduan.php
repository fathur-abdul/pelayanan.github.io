          ...
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <label for="jp">NIK Pemohon :</label>
                  <input type="text" name="jp" id="jp" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['j_pelapor']; ?>" readonly>
                </div>
              </div>
              <div class="row">
                <div class="col-md-4">
                  <label for="dp">NO telp/akun medsos :</label>
                  <input type="text" name="dp" id="dp" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['d_pelapor']; ?>" readonly>
                </div>
                <div class="col-md-4">
                  <label for="nb">Jenis Permohonan :</label>
                  <input type="text" name="nb" id="nb" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['n_barang']; ?>" readonly>
                </div>
              </div>
              <div class="col-md-4">
                  <label for="ks">Klasifikasi sifat :</label>
                  <input type="text" name="ks" id="ks" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['k_sifat']; ?>" readonly>
                </div>
                <div class="col-md-4">
                  <label for="ia">Informasi Aduan :</label>
                  <input type="text" name="ia" id="ia" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['i_aduan']; ?>" readonly>
                </div>
                <div class="col-md-4">
                  <label for="ga">Gambaran singkat Aduan :</label>
                  <input type="text" name="ga" id="ga" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['g_aduan']; ?>" readonly>
                </div>
                <div class="col-md-4">
                  <label for="pp">Petugas Pelayanan :</label>
                  <input type="text" name="pp" id="pp" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['p_pelayanan']; ?>" readonly>
                </div>
              <div class="row">
                <div class="col-md-8">
