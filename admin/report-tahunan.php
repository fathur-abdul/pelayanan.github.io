  ...
  <div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-header">
          <h3 class="card-title"><i class="fas fa-book mr-3"></i>Data Pengaduan Masyarakat</h3>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-hover" id="table-report" width="100%">
              ...
              <th>Nama Pemohon</th>
                <th>NIK Pemohon</th>
                <th>NO telp/akun medsos</th>
                <th>Jenis Permohonan</th>
                <th>Klasifikasi sifat</th>
                <th>Informasi Aduan</th>
                <th>Gambaran singkat Aduan</th>
