...
<head>
  ...
  <title>Dinas Cipta Karya, Bina Kontruksi dan Tata Ruang</title>
  <link rel="icon" href="../assets/dist/img/discipta.png">
...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/dist/img/discipta.png" alt="Discipta" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 19px;">Dinas Cipta Karya, Bina Kontruksi dan Tata Ruang</span>
    </a>
