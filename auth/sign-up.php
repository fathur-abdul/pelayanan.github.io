...
<head>
    ...
    <title>Sign Up | Dinas Cipta Karya, Bina Kontruksi dan Tata Ruang</title>
    ...
    <div class="container">
        <div class="row content">
            ...
            <div class="col-md-6" style="margin-top: -30px;">
                <a class="btn logo" href="../index.php">Dinas Cipta Karya, Bina Kontruksi dan Tata Ruang</a>
                <img src="css/discipta.png" width="40" height="40">
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        <label for="nip">Nomor Induk Pemohon</label>
